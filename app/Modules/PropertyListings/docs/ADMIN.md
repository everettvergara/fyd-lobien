...
1. **Identity** — code*, name*, **summary** (multi-line plain text), **description** (rich text with Visual/Source editor), completion_status, **published_to_public** (Publish to PUBLIC)  
