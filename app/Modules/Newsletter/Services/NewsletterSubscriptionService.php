...
class NewsletterSubscriptionService
{
    ...
    public function subscribe(
        ...
        array $profile = [],
        ?int $userId = null,
        bool $respectFieldSettings = true,
        ...
        foreach (['name', 'mobile_number', 'designation', 'company'] as $field) {
            if (! $respectFieldSettings || ($fields[$field]['enabled'] ?? false)) {
                $attributes[$field] = $profile[$field] ?? null;
            }
        }
