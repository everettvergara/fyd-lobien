    ...
    public function definition(): AdminListDefinition
    {
        return new AdminListDefinition(
            ...
            columns: [
                ...
                AdminListColumn::make('mobile_number', 'Mobile number', fn (NewsletterSubscriber $subscriber) => e($subscriber->mobile_number ?? '—'), sortField: 'newsletter_subscribers.mobile_number', class: 'small text-muted'),
                AdminListColumn::make('designation', 'Designation', fn (NewsletterSubscriber $subscriber) => e($subscriber->designation ?? '—'), sortField: 'newsletter_subscribers.designation', class: 'small text-muted'),
                AdminListColumn::make('company', 'Company', fn (NewsletterSubscriber $subscriber) => e($subscriber->company ?? '—'), sortField: 'newsletter_subscribers.company', class: 'small text-muted'),
            ...
            searchFields: ['email', 'name', 'mobile_number', 'designation', 'company'],
