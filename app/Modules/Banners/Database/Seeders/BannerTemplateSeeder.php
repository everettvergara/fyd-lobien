...
class BannerTemplateSeeder extends Seeder
{
    ...
    protected function templates(): array
    {
        ...
        return [
            ...
            ['key' => 'four_column_full_width', 'name' => 'Four-Column Full Width', 'description' => 'Four independent responsive columns.', 'category' => 'layout', 'schema' => ['columns' => 4, 'stack_mobile' => true, 'slides' => 1, 'blocks' => [$columnBlock(1), $columnBlock(2), $columnBlock(3), $columnBlock(4)], 'buttons' => $columnButtons, 'mediaSlots' => []], 'default_settings' => ['container' => 'full_width']],
            ['key' => 'five_column_full_width', 'name' => 'Five-Column Full Width', 'description' => 'Five independent responsive columns.', 'category' => 'layout', 'schema' => ['columns' => 5, 'stack_mobile' => true, 'slides' => 1, 'blocks' => [$columnBlock(1), $columnBlock(2), $columnBlock(3), $columnBlock(4), $columnBlock(5)], 'buttons' => $columnButtons, 'mediaSlots' => []], 'default_settings' => ['container' => 'full_width']],
            ['key' => 'six_column_full_width', 'name' => 'Six-Column Full Width', 'description' => 'Six independent responsive columns.', 'category' => 'layout', 'schema' => ['columns' => 6, 'stack_mobile' => true, 'slides' => 1, 'blocks' => [$columnBlock(1), $columnBlock(2), $columnBlock(3), $columnBlock(4), $columnBlock(5), $columnBlock(6)], 'buttons' => $columnButtons, 'mediaSlots' => []], 'default_settings' => ['container' => 'full_width']],
