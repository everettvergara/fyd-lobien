        ...
        <div class="lobien-container py-5">
            ...
            <div class="row g-4">
                <div class="col-lg-7">
                    <article>
                        <header class="mb-4">
                            <h1 class="fw-normal text-uppercase">{{ job.title }}</h1>
                        ...
                        <div v-if="job.summary" class="text-muted mb-4">{{ job.summary }}</div>

                        <section v-if="job.description" class="mb-4">
                            <h2 class="h5 text-uppercase mb-3">Description</h2>
                            <div class="content-body" v-html="job.description" />
                        </section>

                        <section v-if="job.requirements">
                            <h2 class="h5 text-uppercase mb-3">Requirements</h2>
